...
public:
    ...
    virtual const bool bottomCollision(const sf::FloatRect &e1Bounds,
                                       const sf::FloatRect &e2Bounds) const;
    virtual const bool topCollision(const sf::FloatRect &e1Bounds,
                                    const sf::FloatRect &e2Bounds) const;
    virtual const bool rightCollision(const sf::FloatRect &e1Bounds,
                                      const sf::FloatRect &e2Bounds) const;
    virtual const bool leftCollision(const sf::FloatRect &e1Bounds,
                                     const sf::FloatRect &e2Bounds) const;
