...
public:
    ...
    void addDrop(const std::string &name, const float &posX, const float &posY,
                 const uint32_t &worth);

    void update(Player *player, PlayerGUI *playerGui, FloatingTextSystem *floatingTextSystem,
