                                          ...
                                          uint32_t price)
{
    this->abilityUpgrades.emplace(
        ...
        BuyItem{
            ...
            new gui::Sprite(this->selectsTexture, t_x - 12, t_y - 12,
                            calcScale(1, vm), false),
            new gui::ButtonSprite(this->selectsTexture, t_x - 12, t_y - 12,
                                  calcScale(1, vm), false),
            new gui::Text(desc, calcChar(16, vm), t_x + 160, t_y - 2,
                          sf::Color(255, 255, 255), true),
            new gui::Text(value, calcChar(16, vm), t_x + 160, t_y + 20,
                          sf::Color(255, 255, 255), true),
            new gui::Sprite(this->attributesTexture, t_x + 126, t_y + 38,
                            calcScale(2, vm), false),
            new gui::Text(std::to_string(price), calcChar(16, vm), t_x + 160,
                          t_y + 48, sf::Color(255, 246, 76), false),
            price,
        });
