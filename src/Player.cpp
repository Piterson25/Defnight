...
Player::Player(const sf::VideoMode &vm, const std::string &hero_name, const float &x,
               const float &y)
{
    this->vm = vm;
    this->name = hero_name;
...
void Player::attackMonster(MonsterSystem *monsterSystem, FloatingTextSystem *floatingTextSystem,
...
void Player::controls(const std::unordered_map<std::string, int> &keybinds, const float &dt)
{
    ...
    const float vel =
        ((this->speed * 0.2f + 0.8f) * 2.f * this->sprite.getGlobalBounds().width) * dt;
...
{
    if (this->name == "ninja") {
        projectileSystem->addProjectile("shuriken", this->getPosition().x + calcX(32, vm),
                                        this->getPosition().y + calcY(32, vm), 3, 3, 4, coords, 0,
                                        false);
        ...
        projectileSystem->addProjectile("shuriken", this->getPosition().x + calcX(32, vm),
                                        this->getPosition().y + calcY(32, vm), 5, 4, 4, coords, 0,
                                        false);
        soundEngine->addSound("shuriken");
        projectileSystem->addProjectile("shuriken", this->getPosition().x + calcX(32, vm),
                                        this->getPosition().y + calcY(32, vm), 5, 4, 4, coords,
                                        -45.f, false);
        soundEngine->addSound("shuriken");
        projectileSystem->addProjectile("shuriken", this->getPosition().x + calcX(32, vm),
                                        this->getPosition().y + calcY(32, vm), 5, 4, 4, coords,
        ...
        projectileSystem->addProjectile("bomb", this->getPosition().x + calcX(32, vm),
                                        this->getPosition().y + calcY(32, vm), 7, 1, 3, coords, 0,
                                        false);
        soundEngine->addSound("shuriken");
    }
    else if (this->name == "crusader") {
...
{
    this->shadow.setPosition(this->sprite.getPosition().x,
                             this->sprite.getPosition().y + calcY(52, this->vm));
...
void Player::draw(sf::RenderTarget &target)
{
    ...
    if (this->abilityActive && (this->increasedArmor || this->name == "scout")) {
