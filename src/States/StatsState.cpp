...
StatsState::StatsState(float gridSize, sf::RenderWindow &window, GameSettings &gameSettings, SoundEngine &soundEngine,
...
void StatsState::initGUI()
{
    this->texts["STATISTICS"] =
        std::make_unique<gui::Text>(this->gameSettings.lang["STATISTICS"], calcChar(32, vm), calcX(640, vm),
