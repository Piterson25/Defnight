...
void Game::init()
{
    ...
    if (this->gameSettings.fullscreen) {
        this->window =
            new sf::RenderWindow(this->gameSettings.resolution, "Defnight", sf::Style::Fullscreen);
    }
    else {
        this->window = new sf::RenderWindow(this->gameSettings.resolution, "Defnight",
    ...
    this->fps = 0;
    this->fpsTimer = 0.f;
    this->fpsCounter = new gui::Text(&this->font, "", calcChar(16, vm), calcX(4, vm), calcY(4, vm),
    ...
    this->states.push(new MainMenuState(this->gridSize, this->window, &this->gameSettings,
                                        &this->supportedKeys, &this->font, this->soundEngine,
