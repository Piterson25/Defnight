    ...
    : font(*font), player(player), vm(vm), lang(lang)
{
    ...
    this->sprites["TOP_GUI"] =
        new gui::Sprite("assets/textures/top_gui.png", 0, 0, calcScale(1, vm), false);

    this->sprites["PROGRESS_BAR"] = new gui::Sprite(
        "assets/textures/progress_bar.png", calcX(640, vm), calcY(44, vm), calcScale(1, vm), true);
    this->sprites["PROGRESS_BAR"]->setColor(sf::Color::Transparent);

    this->sprites["MINIATURE"] = new gui::Sprite(this->upgrades_texture, calcX(164, vm),
                                                 calcX(16, vm), calcScale(4, vm), false);
    this->sprites["MINIATURE"]->setTextureRect(sf::IntRect(0, 0, 16, 16));
    this->texts["NAME"] =
        new gui::Text(&this->font, this->lang["WARRIOR"], calcChar(16, vm), calcX(196, vm),
                      calcY(96, vm), sf::Color(255, 255, 255), true);

    this->sprites["GOLD"] =
        new gui::Sprite(attributes_texture, 0, calcY(86, vm), calcScale(2, vm), false);
    this->sprites["GOLD"]->setTextureRect(sf::IntRect(0, 0, 16, 16));
    this->texts["GOLD"] =
        new gui::Text(&this->font, std::to_string(player->getGold()), calcChar(16, vm),
                      calcX(36, vm), calcY(96, vm), sf::Color(255, 246, 76), false);

    this->sprites["ARMOR"] =
        new gui::Sprite(attributes_texture, calcX(372, vm), calcY(16, vm), calcScale(2, vm), false);
    this->sprites["ARMOR"]->setTextureRect(sf::IntRect(16, 0, 16, 16));
    this->texts["ARMOR"] =
        new gui::Text(&this->font, std::to_string(player->getArmor()), calcChar(16, vm),
                      calcX(388, vm), calcY(70, vm), sf::Color(192, 192, 192), true);

    this->sprites["REG"] =
        new gui::Sprite(attributes_texture, calcX(436, vm), calcY(16, vm), calcScale(2, vm), false);
    this->sprites["REG"]->setTextureRect(sf::IntRect(32, 0, 16, 16));
    this->texts["REG"] =
        new gui::Text(&this->font, std::to_string(player->getReg()), calcChar(16, vm),
                      calcX(452, vm), calcY(70, vm), sf::Color(182, 60, 53), true);

    this->sprites["ATTACK"] =
        new gui::Sprite(attributes_texture, calcX(812, vm), calcY(16, vm), calcScale(2, vm), false);
    this->sprites["ATTACK"]->setTextureRect(sf::IntRect(80, 0, 16, 16));
    this->texts["ATTACK"] =
        new gui::Text(&this->font, std::to_string(player->getAttack()), calcChar(16, vm),
                      calcX(828, vm), calcY(70, vm), sf::Color(192, 192, 192), true);

    this->sprites["ATTACK_SPEED"] =
        new gui::Sprite(attributes_texture, calcX(876, vm), calcY(16, vm), calcScale(2, vm), false);
    this->sprites["ATTACK_SPEED"]->setTextureRect(sf::IntRect(96, 0, 16, 16));
    this->texts["ATTACK_SPEED"] =
        new gui::Text(&this->font, std::to_string(player->getAttackSpeed()), calcChar(16, vm),
                      calcX(892, vm), calcY(70, vm), sf::Color(192, 192, 192), true);

    this->sprites["SPEED"] =
        new gui::Sprite(attributes_texture, calcX(940, vm), calcY(16, vm), calcScale(2, vm), false);
    this->sprites["SPEED"]->setTextureRect(sf::IntRect(112, 0, 16, 16));
    this->texts["SPEED"] =
        new gui::Text(&this->font, std::to_string(player->getSpeed()), calcChar(16, vm),
                      calcX(956, vm), calcY(70, vm), sf::Color(192, 192, 192), true);

    this->sprites["CRITICAL"] = new gui::Sprite(attributes_texture, calcX(1004, vm), calcY(16, vm),
                                                calcScale(2, vm), false);
    this->sprites["CRITICAL"]->setTextureRect(sf::IntRect(128, 0, 16, 16));
    this->texts["CRITICAL"] = new gui::Text(
        &this->font, std::to_string(player->getCriticalChance()) + "%", calcChar(16, vm),
        calcX(1020, vm), calcY(70, vm), sf::Color(192, 192, 192), true);

    this->sprites["XP_BAR"] = new gui::Sprite("assets/textures/bars.png", calcX(508, vm),
                                              calcY(12, vm), calcScale(1, vm), false);
    this->sprites["XP_BAR"]->setTextureRect(sf::IntRect(0, 0, 0, 0));
    this->texts["XP"] = new gui::Text(&this->font,
                                      "XP:" + std::to_string(this->player->getXP()) + "/" +
                                          std::to_string(this->player->getMaxXP()),
                                      calcChar(16, vm), calcX(640, vm), calcY(15, vm),
                                      sf::Color(255, 255, 255), true);
    this->texts["LEVEL"] = new gui::Text(
        &this->font, "Level " + std::to_string(this->player->getLevel()), calcChar(16, vm),
        calcX(640, vm), calcY(15, vm), sf::Color(255, 255, 255), true);
    this->isLevelshown = true;
    this->xp_bar_percent = 0.f;

    this->sprites["HP_BAR"] = new gui::Sprite("assets/textures/bars.png", calcX(508, vm),
                                              calcY(52, vm), calcScale(1, vm), false);
    this->sprites["HP_BAR"]->setTextureRect(sf::IntRect(0, 20, 264, 20));
    this->texts["HP"] = new gui::Text(&this->font,
                                      "HP:" + std::to_string(this->player->getHP()) + "/" +
                                          std::to_string(this->player->getMaxHP()),
                                      calcChar(16, vm), calcX(640, vm), calcY(55, vm),
                                      sf::Color(255, 255, 255), true);
    this->hp_bar_percent = 1.f;

    this->sprites["SPRINT_BAR"] = new gui::Sprite("assets/textures/bars.png", calcX(508, vm),
                                                  calcY(92, vm), calcScale(1, vm), false);
    this->sprites["SPRINT_BAR"]->setTextureRect(sf::IntRect(0, 40, 264, 20));
    this->texts["SPRINT"] = new gui::Text(&this->font,
                                          std::to_string(this->player->getSprint()) + "/" +
                                              std::to_string(this->player->getMaxSprint()),
                                          calcChar(16, vm), calcX(640, vm), calcY(95, vm),
                                          sf::Color(255, 255, 255), true);

    this->texts["MONSTER_COUNT"] =
        new gui::Text(&this->font, this->lang["MONSTER_COUNT"], calcChar(16, vm), calcX(906, vm),
                      calcY(96, vm), sf::Color(130, 139, 152), false);
    this->texts["MONSTER_COUNT"]->setPosition(
        sf::Vector2f(calcX(1218, vm) - this->texts["MONSTER_COUNT"]->getWidth(), calcY(96, vm)));

    this->texts["WAVE_NUMBER"] =
        new gui::Text(&this->font, this->lang["WAVE"], calcChar(32, vm), calcX(1060, vm),
                      calcY(4, vm), sf::Color(228, 92, 95), false);
    this->texts["WAVE_COUNTDOWN"] =
        new gui::Text(&this->font, this->lang["NEXT_WAVE"], calcChar(16, vm), calcX(954, vm),
                      calcY(96, vm), sf::Color(255, 246, 76), false);
    this->texts["WAVE_COUNTDOWN"]->setPosition(
        sf::Vector2f(calcX(1218, vm) - this->texts["WAVE_COUNTDOWN"]->getWidth(), calcY(96, vm)));
    this->titleCooldown = 0.f;
    this->texts["WAVE_NEW_MOBS"] = new gui::Text(&this->font, "", calcChar(16, vm), calcX(640, vm),
                                                 calcY(562, vm), sf::Color(228, 92, 95), true);
    this->texts["BIG_WAVE_NUMBER"] =
        new gui::Text(&this->font, this->lang["WAVE"], calcChar(64, vm), calcX(640, vm),
                      calcY(256, vm), sf::Color(255, 255, 255), true);
    this->texts["MOBS_TO_KILL"] =
        new gui::Text(&this->font, this->lang["MONSTER"], calcChar(32, vm), calcX(640, vm),
    ...
    this->texts["LEVEL_UP"] =
        new gui::Text(&this->font, "LEVEL UP!", calcChar(32, vm), calcX(640, vm), calcY(256, vm),
                      sf::Color(255, 246, 76), true);
    this->sprites["LEVEL_UP"] = new gui::Sprite("assets/textures/bottom_gui.png", calcX(640, vm),
                                                calcY(476, vm), calcScale(1, vm), true);

    this->sprites["OPTION1_FRAME"] = new gui::Sprite(this->select_texture, calcX(504, vm),
                                                     calcY(512, vm), calcScale(1, vm), false);
    this->sprites["OPTION1_FRAME"]->setTextureRect(sf::IntRect(88, 0, 88, 88));
    this->sprites["OPTION2_FRAME"] = new gui::Sprite(this->select_texture, calcX(688, vm),
                                                     calcY(512, vm), calcScale(1, vm), false);
    this->sprites["OPTION2_FRAME"]->setTextureRect(sf::IntRect(88, 0, 88, 88));
    this->sprite_buttons["OPTION1"] = new gui::ButtonSprite(
        this->select_texture, calcX(504, vm), calcY(512, vm), calcScale(1, vm), false);
    this->sprite_buttons["OPTION1"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprite_buttons["OPTION2"] = new gui::ButtonSprite(
        this->select_texture, calcX(688, vm), calcY(512, vm), calcScale(1, vm), false);
    this->sprite_buttons["OPTION2"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprites["OPTION1"] = new gui::Sprite(this->attributes_texture, calcX(516, vm),
                                               calcY(524, vm), calcScale(4, vm), false);
    this->sprites["OPTION2"] = new gui::Sprite(this->attributes_texture, calcX(700, vm),
                                               calcY(524, vm), calcScale(4, vm), false);
    this->texts["OPTION1"] = new gui::Text(&this->font, "", calcChar(16, vm), calcX(548, vm),
                                           calcY(612, vm), sf::Color(255, 255, 255), false);
    this->texts["OPTION2"] = new gui::Text(&this->font, "", calcChar(16, vm), calcX(732, vm),
                                           calcY(612, vm), sf::Color(255, 255, 255), false);
    this->texts["OPTION1_VALUE"] = new gui::Text(&this->font, "", calcChar(16, vm), calcX(548, vm),
                                                 calcY(636, vm), sf::Color(255, 255, 255), false);
    this->texts["OPTION2_VALUE"] = new gui::Text(&this->font, "", calcChar(16, vm), calcX(732, vm),
                                                 calcY(636, vm), sf::Color(255, 255, 255), false);
    ...
    this->sprites["UPGRADES"] = new gui::Sprite("assets/textures/side_gui.png", calcX(1280, vm),
                                                calcY(128, vm), calcScale(1, vm), false);
    this->sprites["UPGRADES"]->flipHorizontal();

    this->sprites["UPGRADE1_FRAME"] = new gui::Sprite(this->select_texture, calcX(1008, vm),
                                                      calcY(210, vm), calcScale(1, vm), false);
    this->sprites["UPGRADE1_FRAME"]->setTextureRect(sf::IntRect(88, 0, 88, 88));
    this->sprites["UPGRADE2_FRAME"] = new gui::Sprite(this->select_texture, calcX(1008, vm),
                                                      calcY(380, vm), calcScale(1, vm), false);
    this->sprites["UPGRADE2_FRAME"]->setTextureRect(sf::IntRect(88, 0, 88, 88));
    this->sprites["UPGRADE3_FRAME"] = new gui::Sprite(this->select_texture, calcX(1008, vm),
                                                      calcY(550, vm), calcScale(1, vm), false);
    this->sprites["UPGRADE3_FRAME"]->setTextureRect(sf::IntRect(88, 0, 88, 88));
    this->sprite_buttons["UPGRADE1"] = new gui::ButtonSprite(
        this->select_texture, calcX(1008, vm), calcY(210, vm), calcScale(1, vm), false);
    this->sprite_buttons["UPGRADE1"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprite_buttons["UPGRADE2"] = new gui::ButtonSprite(
        this->select_texture, calcX(1008, vm), calcY(380, vm), calcScale(1, vm), false);
    this->sprite_buttons["UPGRADE2"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprite_buttons["UPGRADE3"] = new gui::ButtonSprite(
        this->select_texture, calcX(1008, vm), calcY(550, vm), calcScale(1, vm), false);
    this->sprite_buttons["UPGRADE3"]->setTextureRect(sf::IntRect(0, 0, 88, 88));

    this->sprites["UPGRADE1"] = new gui::Sprite(this->upgrades_texture, calcX(1020, vm),
                                                calcY(222, vm), calcScale(4, vm), false);
    this->sprites["UPGRADE1"]->setTextureRect(sf::IntRect(16, 0, 16, 16));
    this->sprites["UPGRADE2"] = new gui::Sprite(this->upgrades_texture, calcX(1020, vm),
                                                calcY(392, vm), calcScale(4, vm), false);
    this->sprites["UPGRADE2"]->setTextureRect(sf::IntRect(32, 0, 16, 16));
    this->sprites["UPGRADE3"] = new gui::Sprite(this->upgrades_texture, calcX(1020, vm),
                                                calcY(562, vm), calcScale(4, vm), false);
    this->sprites["UPGRADE3"]->setTextureRect(sf::IntRect(48, 0, 16, 16));

    this->texts["UPGRADE1_NAME"] =
        new gui::Text(&this->font, this->lang["NINJA"], calcChar(16, vm), calcX(1112, vm),
                      calcY(226, vm), sf::Color(255, 255, 255), false);
    this->texts["UPGRADE2_NAME"] =
        new gui::Text(&this->font, this->lang["KNIGHT"], calcChar(16, vm), calcX(1112, vm),
                      calcY(396, vm), sf::Color(255, 255, 255), false);
    this->texts["UPGRADE3_NAME"] =
        new gui::Text(&this->font, this->lang["SCOUT"], calcChar(16, vm), calcX(1112, vm),
                      calcY(566, vm), sf::Color(255, 255, 255), false);

    this->sprites["UPGRADE1_ABILITY"] = new gui::Sprite(this->abilities_texture, calcX(1112, vm),
                                                        calcY(256, vm), calcScale(2, vm), false);
    this->sprites["UPGRADE1_ABILITY"]->setTextureRect(sf::IntRect(0, 0, 16, 16));
    this->sprites["UPGRADE2_ABILITY"] = new gui::Sprite(this->abilities_texture, calcX(1112, vm),
                                                        calcY(426, vm), calcScale(2, vm), false);
    this->sprites["UPGRADE2_ABILITY"]->setTextureRect(sf::IntRect(16, 0, 16, 16));
    this->sprites["UPGRADE3_ABILITY"] = new gui::Sprite(this->abilities_texture, calcX(1112, vm),
                                                        calcY(596, vm), calcScale(2, vm), false);
    this->sprites["UPGRADE3_ABILITY"]->setTextureRect(sf::IntRect(32, 0, 16, 16));

    this->sprites["UPGRADE1_ADD"] = new gui::Sprite(this->attributes_texture, calcX(1184, vm),
                                                    calcY(256, vm), calcScale(2, vm), false);
    this->sprites["UPGRADE1_ADD"]->setTextureRect(sf::IntRect(112, 0, 16, 16));
    this->sprites["UPGRADE2_ADD"] = new gui::Sprite(this->attributes_texture, calcX(1184, vm),
                                                    calcY(426, vm), calcScale(2, vm), false);
    this->sprites["UPGRADE2_ADD"]->setTextureRect(sf::IntRect(80, 0, 16, 16));
    this->sprites["UPGRADE3_ADD"] = new gui::Sprite(this->attributes_texture, calcX(1184, vm),
                                                    calcY(596, vm), calcScale(2, vm), false);
    this->sprites["UPGRADE3_ADD"]->setTextureRect(sf::IntRect(32, 0, 16, 16));

    this->texts["UPGRADE1_ADD_VALUE"] =
        new gui::Text(&this->font, "+1", calcChar(16, vm), calcX(1224, vm), calcY(266, vm),
                      sf::Color(255, 255, 255), false);
    this->texts["UPGRADE2_ADD_VALUE"] =
        new gui::Text(&this->font, "+1", calcChar(16, vm), calcX(1224, vm), calcY(436, vm),
                      sf::Color(255, 255, 255), false);
    this->texts["UPGRADE3_ADD_VALUE"] =
        new gui::Text(&this->font, "+1", calcChar(16, vm), calcX(1224, vm), calcY(606, vm),
                      sf::Color(255, 255, 255), false);

    this->sprites["ABILITY_FRAME"] = new gui::Sprite(this->select_texture, calcX(264, vm),
                                                     calcY(4, vm), calcScale(1, vm), false);
    this->sprites["ABILITY_FRAME"]->setTextureRect(sf::IntRect(440, 0, 88, 88));
    this->sprites["ABILITY_ICON"] =
        new gui::Sprite("assets/textures/abilities_icons.png", calcX(276, vm), calcY(16, vm),
    ...
    this->texts["YOU_DIED"] =
        new gui::Text(&this->font, this->lang["YOU_DIED"], calcChar(72, vm), calcX(640, vm),
                      calcY(224, vm), sf::Color(255, 255, 255), true);
    this->text_buttons["RESUME"] = new gui::ButtonText(
        &this->font, this->lang["RESUME"], calcChar(32, vm), calcX(640, vm), calcY(296, vm),
        sf::Color(255, 255, 255), sf::Color(192, 192, 192), true);
    this->text_buttons["MAIN_MENU"] = new gui::ButtonText(
        &this->font, this->lang["MAIN_MENU"], calcChar(32, vm), calcX(640, vm), calcY(392, vm),
        sf::Color(255, 255, 255), sf::Color(192, 192, 192), true);
    this->text_buttons["SETTINGS"] = new gui::ButtonText(
        &this->font, this->lang["SETTINGS"], calcChar(32, vm), calcX(640, vm), calcY(488, vm),
        sf::Color(255, 255, 255), sf::Color(192, 192, 192), true);
    this->text_buttons["QUIT"] = new gui::ButtonText(
        &this->font, this->lang["QUIT"], calcChar(32, vm), calcX(640, vm), calcY(584, vm),
        sf::Color(255, 255, 255), sf::Color(192, 192, 192), true);

    this->texts["KILLS"] = new gui::Text(
        &this->font, this->lang["KILLS"] + std::to_string(this->player->getKills()),
        calcChar(16, vm), calcX(640, vm), calcY(160, vm), sf::Color(192, 192, 192), true);

    if (difficulty_name == "easy") {
        this->texts["DIFFICULTY"] = new gui::Text(
            &this->font, this->lang["DIFFICULTY_LEVEL"] + " " + this->lang["EASY"],
            calcChar(16, vm), calcX(640, vm), calcY(144, vm), sf::Color(182, 60, 53), true);
    }
    else if (difficulty_name == "normal") {
        this->texts["DIFFICULTY"] = new gui::Text(
            &this->font, this->lang["DIFFICULTY_LEVEL"] + " " + this->lang["NORMAL"],
            calcChar(16, vm), calcX(640, vm), calcY(144, vm), sf::Color(182, 60, 53), true);
    }
    else if (difficulty_name == "hard") {
        this->texts["DIFFICULTY"] = new gui::Text(
            &this->font, this->lang["DIFFICULTY_LEVEL"] + " " + this->lang["HARD"],
            calcChar(16, vm), calcX(640, vm), calcY(144, vm), sf::Color(182, 60, 53), true);
    }
    ...
    this->sprites["SIDE_GUI"] =
        new gui::Sprite("assets/textures/side_gui.png", 0, calcY(128, vm), calcScale(1, vm), false);

    this->sprites["ITEM1"] =
        new gui::Sprite(attributes_texture, calcX(44, vm), calcY(192, vm), calcScale(4, vm), false);
    this->sprites["ITEM1"]->setTextureRect(sf::IntRect(144, 0, 16, 16));
    this->sprites["ITEM2"] =
        new gui::Sprite(attributes_texture, calcX(44, vm), calcY(320, vm), calcScale(4, vm), false);
    this->sprites["ITEM2"]->setTextureRect(sf::IntRect(48, 0, 16, 16));
    this->sprites["ITEM3"] =
        new gui::Sprite(attributes_texture, calcX(44, vm), calcY(448, vm), calcScale(4, vm), false);
    this->sprites["ITEM3"]->setTextureRect(sf::IntRect(80, 0, 16, 16));
    this->sprites["ITEM4"] =
        new gui::Sprite(attributes_texture, calcX(44, vm), calcY(576, vm), calcScale(4, vm), false);
    this->sprites["ITEM4"]->setTextureRect(sf::IntRect(16, 0, 16, 16));

    this->sprites["ITEM1_FRAME"] = new gui::Sprite(this->select_texture, calcX(32, vm),
                                                   calcY(180, vm), calcScale(1, vm), false);
    this->sprites["ITEM1_FRAME"]->setTextureRect(sf::IntRect(176, 0, 88, 88));
    this->sprites["ITEM2_FRAME"] = new gui::Sprite(this->select_texture, calcX(32, vm),
                                                   calcY(308, vm), calcScale(1, vm), false);
    this->sprites["ITEM2_FRAME"]->setTextureRect(sf::IntRect(176, 0, 88, 88));
    this->sprites["ITEM3_FRAME"] = new gui::Sprite(this->select_texture, calcX(32, vm),
                                                   calcY(436, vm), calcScale(1, vm), false);
    this->sprites["ITEM3_FRAME"]->setTextureRect(sf::IntRect(176, 0, 88, 88));
    this->sprites["ITEM4_FRAME"] = new gui::Sprite(this->select_texture, calcX(32, vm),
                                                   calcY(564, vm), calcScale(1, vm), false);
    this->sprites["ITEM4_FRAME"]->setTextureRect(sf::IntRect(176, 0, 88, 88));

    this->sprite_buttons["ITEM1"] = new gui::ButtonSprite(this->select_texture, calcX(32, vm),
                                                          calcY(180, vm), calcScale(1, vm), false);
    this->sprite_buttons["ITEM1"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprite_buttons["ITEM2"] = new gui::ButtonSprite(this->select_texture, calcX(32, vm),
                                                          calcY(308, vm), calcScale(1, vm), false);
    this->sprite_buttons["ITEM2"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprite_buttons["ITEM3"] = new gui::ButtonSprite(this->select_texture, calcX(32, vm),
                                                          calcY(436, vm), calcScale(1, vm), false);
    this->sprite_buttons["ITEM3"]->setTextureRect(sf::IntRect(0, 0, 88, 88));
    this->sprite_buttons["ITEM4"] = new gui::ButtonSprite(this->select_texture, calcX(32, vm),
                                                          calcY(564, vm), calcScale(1, vm), false);
    this->sprite_buttons["ITEM4"]->setTextureRect(sf::IntRect(0, 0, 88, 88));

    this->texts["ITEM1"] = new gui::Text(&this->font, "Full HP", calcChar(16, vm), calcX(204, vm),
                                         calcY(190, vm), sf::Color(255, 255, 255), true);
    this->texts["ITEM2"] =
        new gui::Text(&this->font, this->lang["MAX_HP"], calcChar(16, vm), calcX(204, vm),
                      calcY(318, vm), sf::Color(255, 255, 255), true);
    this->texts["ITEM3"] =
        new gui::Text(&this->font, this->lang["ATTACK"], calcChar(16, vm), calcX(204, vm),
                      calcY(446, vm), sf::Color(255, 255, 255), true);
    this->texts["ITEM4"] =
        new gui::Text(&this->font, this->lang["ARMOR"], calcChar(16, vm), calcX(204, vm),
                      calcY(574, vm), sf::Color(255, 255, 255), true);

    this->texts["ITEM1_VALUE"] =
        new gui::Text(&this->font, "+Full", calcChar(16, vm), calcX(204, vm), calcY(212, vm),
                      sf::Color(255, 255, 255), true);
    this->texts["ITEM2_VALUE"] = new gui::Text(&this->font, "+2", calcChar(16, vm), calcX(204, vm),
                                               calcY(340, vm), sf::Color(255, 255, 255), true);
    this->texts["ITEM3_VALUE"] = new gui::Text(&this->font, "+1", calcChar(16, vm), calcX(204, vm),
                                               calcY(468, vm), sf::Color(255, 255, 255), true);
    this->texts["ITEM4_VALUE"] = new gui::Text(&this->font, "+1", calcChar(16, vm), calcX(204, vm),
                                               calcY(596, vm), sf::Color(255, 255, 255), true);

    this->sprites["ITEM1_COIN"] = new gui::Sprite(attributes_texture, calcX(170, vm),
                                                  calcY(230, vm), calcScale(2, vm), false);
    this->sprites["ITEM1_COIN"]->setTextureRect(sf::IntRect(0, 0, 16, 16));
    this->sprites["ITEM2_COIN"] = new gui::Sprite(attributes_texture, calcX(170, vm),
                                                  calcY(358, vm), calcScale(2, vm), false);
    this->sprites["ITEM2_COIN"]->setTextureRect(sf::IntRect(0, 0, 16, 16));
    this->sprites["ITEM3_COIN"] = new gui::Sprite(attributes_texture, calcX(170, vm),
                                                  calcY(486, vm), calcScale(2, vm), false);
    this->sprites["ITEM3_COIN"]->setTextureRect(sf::IntRect(0, 0, 16, 16));
    this->sprites["ITEM4_COIN"] = new gui::Sprite(attributes_texture, calcX(170, vm),
                                                  calcY(614, vm), calcScale(2, vm), false);
    ...
    this->texts["ITEM1_PRICE"] =
        new gui::Text(&this->font, std::to_string(this->item1Price), calcChar(16, vm),
                      calcX(204, vm), calcY(240, vm), sf::Color(255, 246, 76), false);
    this->texts["ITEM2_PRICE"] =
        new gui::Text(&this->font, std::to_string(this->item2Price), calcChar(16, vm),
                      calcX(204, vm), calcY(368, vm), sf::Color(255, 246, 76), false);
    this->texts["ITEM3_PRICE"] =
        new gui::Text(&this->font, std::to_string(this->item3Price), calcChar(16, vm),
                      calcX(204, vm), calcY(496, vm), sf::Color(255, 246, 76), false);
    this->texts["ITEM4_PRICE"] =
        new gui::Text(&this->font, std::to_string(this->item4Price), calcChar(16, vm),
                      calcX(204, vm), calcY(624, vm), sf::Color(255, 246, 76), false);

    this->isBuyingAbility = false;
    this->sprites["BUYING_ABILITY_ICON"] =
        new gui::Sprite("assets/textures/abilities_icons.png", calcX(80, vm), calcY(160, vm),
    ...
    this->texts["BOSS"] = new gui::Text(&this->font, "Minotaur", calcChar(16, vm), calcX(640, vm),
                                        calcY(136, vm), sf::Color(113, 43, 59), true);
    this->sprites["BOSS_BAR"] = new gui::Sprite("assets/textures/bars.png", calcX(376, vm),
                                                calcY(158, vm), calcScale(1, vm), false);
    this->sprites["BOSS_BAR"]->setTextureRect(sf::IntRect(0, 60, 528, 20));
    this->sprites["BOSS_BAR_EMPTY"] = new gui::Sprite("assets/textures/bars.png", calcX(376, vm),
                                                      calcY(158, vm), calcScale(1, vm), false);
...
void PlayerGUI::update_options(uint32_t &option_id, uint32_t &option_val,
                               std::vector<short> &id_vector, gui::Text *text, gui::Text *value,
    ...
    switch (option_id) {
        ...
        case 4:
            ...
            this->texts["SPRINT"]->setText(
                std::to_string(static_cast<uint32_t>(this->player->getSprint())) + "/" +
                std::to_string(this->player->getMaxSprint()));
...
void PlayerGUI::update_level(SoundEngine *soundEngine)
{
    ...
    if (this->player->getLevel() == 5 ||
        (this->player->getLevel() == 10 && this->player->getName() != "scout")) {
        this->isUpgrading = true;
    }

    std::vector<short> id = {3, 4, 5};
    if (this->player->getArmor() < 10 ||
        (this->player->getIncreasedArmor() &&
         ((this->player->getAbilityActive() && this->player->getArmor() < 15) ||
          (!this->player->getAbilityActive() && this->player->getArmor() < 10)))) {
        id.push_back(1);
    }
    if (this->player->getReg() < 10) {
        id.push_back(2);
    }
    if (this->player->getAttackSpeed() < 10) {
        id.push_back(6);
    }
    if (this->player->getSpeed() < 10) {
        id.push_back(7);
    }
    if (this->player->getCriticalChance() < 100) {
        id.push_back(8);
    }

    update_options(this->option1_id, this->option1_val, id, this->texts["OPTION1"],
                   this->texts["OPTION1_VALUE"], this->sprites["OPTION1"], calcX(548, vm));
    update_options(this->option2_id, this->option2_val, id, this->texts["OPTION2"],
                   this->texts["OPTION2_VALUE"], this->sprites["OPTION2"], calcX(732, vm));
...
{
    this->xp_bar_percent =
        static_cast<float>(this->player->getXP() - this->player->getLastMaxXP()) /
        static_cast<float>(this->player->getMaxXP() - this->player->getLastMaxXP());
    this->texts["XP"]->setText("XP:" + std::to_string(this->player->getXP()) + "/" +
                               std::to_string(this->player->getMaxXP()));
...
void PlayerGUI::updating_XP(const float &dt)
{
    ...
    if (width < barrier && this->player->getLeveling()) {
        ...
        this->player->setIsLeveling(false);
    }
}
...
void PlayerGUI::update_HP()
{
    ...
    this->texts["HP"]->setText("HP:" + std::to_string(this->player->getHP()) + "/" +
                               std::to_string(this->player->getMaxHP()));
...
void PlayerGUI::update_ability(const float &dt)
{
    if (this->player->getAbilityCooldown() > 0.f) {
        const float value =
            this->player->getAbilityCooldown() / this->player->getAbilityMaxTime() * calcX(80, vm);
...
void PlayerGUI::updateSprint(const float &dt)
{
    ...
    const int barrier_width = static_cast<int>(
        this->player->getSprint() / static_cast<float>(this->player->getMaxSprint()) * 264.f);
...
void PlayerGUI::updateMonsterCountWave(const std::string &language, const uint32_t &wave,
    ...
    if (this->isShopping) {
        if (this->player->getGold() >= this->item1Price &&
            ...
            if (this->sprite_buttons["ITEM1"]->isPressed() && !mouseClicked) {
                ...
                floatingTextSystem->addFloatingText("-" + std::to_string(this->item1Price),
                                                    calcChar(16, vm), calcX(20, vm), calcY(96, vm),
                                                    sf::Color(255, 246, 76), true);
                ...
                this->item1Price +=
                    static_cast<uint32_t>((((1 + sqrtf(5)) / 2.f) - 1) * this->item1Price);
        ...
        if (this->player->getGold() >= this->item2Price) {
            ...
            if (this->sprite_buttons["ITEM2"]->isPressed() && !mouseClicked) {
                ...
                floatingTextSystem->addFloatingText("-" + std::to_string(this->item2Price),
                                                    calcChar(16, vm), calcX(20, vm), calcY(96, vm),
                                                    sf::Color(255, 246, 76), true);
                this->player->setMaxHP(this->player->getMaxHP() + 2);
                this->update_HP();
                ...
                this->item2Price +=
                    static_cast<uint32_t>((((1 + sqrtf(5)) / 2.f) - 1) * this->item2Price);
        ...
        if (this->player->getGold() >= this->item3Price) {
            ...
            if (this->sprite_buttons["ITEM3"]->isPressed() && !mouseClicked) {
                ...
                floatingTextSystem->addFloatingText("-" + std::to_string(this->item3Price),
                                                    calcChar(16, vm), calcX(20, vm), calcY(96, vm),
                                                    sf::Color(255, 246, 76), true);
                this->player->setAttack(this->player->getAttack() + 1);
                this->texts["ATTACK"]->setText(std::to_string(this->player->getAttack()));
                ...
                this->item3Price +=
                    static_cast<uint32_t>((((1 + sqrtf(5)) / 2.f) - 1) * this->item3Price);
            ...
            if (this->player->getGold() >= this->item4Price) {
                ...
                if (this->sprite_buttons["ITEM4"]->isPressed() && !mouseClicked) {
                    ...
                    floatingTextSystem->addFloatingText(
                        "-" + std::to_string(this->item4Price), calcChar(16, vm), calcX(20, vm),
                    ...
                    this->item4Price +=
                        static_cast<uint32_t>((((1 + sqrtf(5)) / 2.f) - 1) * this->item4Price);
...
const bool PlayerGUI::updateBuyingAbility(const sf::Vector2i &mousePos, const bool &mouseClicked,
                                          SoundEngine *soundEngine,
...
void PlayerGUI::update(sf::Vector2f &mousePosView, const float &waveCountdown,
                       MonsterSystem *monsterSystem, const float &dt)
{
    ...
    if (this->bossWave) {
        ...
        if (this->boss_bar_percent != 0.f && this->bossCooldown < 255.f) {
            ...
            this->texts["BOSS"]->setFillColor(
                sf::Color(113, 43, 59, static_cast<sf::Uint8>(this->bossCooldown)));
            this->sprites["BOSS_BAR_EMPTY"]->setColor(
                sf::Color(255, 255, 255, static_cast<sf::Uint8>(this->bossCooldown)));
            this->sprites["BOSS_BAR"]->setTextureRect(
                sf::IntRect(0, 60, static_cast<int>(this->bossCooldown / 255.f * 528.f), 20));

            this->sprites["BOSS_BAR"]->setColor(
                sf::Color(255, 255, 255, static_cast<sf::Uint8>(this->bossCooldown)));
        }
    ...
    if (this->waveCountdown < 10.f) {
        this->texts["WAVE_COUNTDOWN"]->setText(
            this->lang["NEXT_WAVE"] + std::to_string(static_cast<int>(11.f - this->waveCountdown)));
        ...
        this->texts["WAVE_COUNTDOWN"]->setText(
            this->lang["NEXT_WAVE"] + std::to_string(10 - static_cast<int>(waveCountdown)));
    }
}
